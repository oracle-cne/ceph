...
%build
pushd container
NO_PUSH=true CI_CONTAINER=false VERSION="19.2.4" CEPH_VERSION="19.2.4" CONTAINER_REPO_HOSTNAME=container-registry.oracle.com \
...
%changelog
* Thu May 28 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 19.2.4-1
- Added Oracle specific files for 19.2.4
