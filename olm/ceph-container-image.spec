...
%build
pushd container
NO_PUSH=true CI_CONTAINER=false VERSION="18.2.8" CEPH_VERSION="18.2.8" CONTAINER_REPO_HOSTNAME=container-registry.oracle.com \
...
%changelog
* Fri Mar 13 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 18.2.8-1
- Added Oracle specific files for 18.2.8
