...
%build
pushd container
NO_PUSH=true CI_CONTAINER=false VERSION="21.1.0" CEPH_VERSION="21.1.0" CONTAINER_REPO_HOSTNAME=container-registry.oracle.com \
...
%changelog
* Fri Jul 17 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 21.1.0-1
- Added Oracle specific files for 21.1.0
