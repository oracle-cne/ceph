...
%build
pushd container
NO_PUSH=true CI_CONTAINER=false VERSION="20.1.1" CEPH_VERSION="20.1.1" CONTAINER_REPO_HOSTNAME=container-registry.oracle.com \
...
%changelog
* Tue Aug 11 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 20.1.1-1
- Added Oracle specific files for 20.1.1
