...
%build
pushd container
NO_PUSH=true CI_CONTAINER=false VERSION="21.0.0" CEPH_VERSION="21.0.0" CONTAINER_REPO_HOSTNAME=container-registry.oracle.com \
...
%changelog
* Fri Mar 27 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 21.0.0-1
- Added Oracle specific files for 21.0.0
