...
%build
pushd container
NO_PUSH=true CI_CONTAINER=false VERSION="21.0.1" CEPH_VERSION="21.0.1" CONTAINER_REPO_HOSTNAME=container-registry.oracle.com \
...
%changelog
* Thu Jun 11 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 21.0.1-1
- Added Oracle specific files for 21.0.1
