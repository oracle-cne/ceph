...
%build
pushd container
NO_PUSH=true CI_CONTAINER=false VERSION="20.2.4" CEPH_VERSION="20.2.4" CONTAINER_REPO_HOSTNAME=container-registry.oracle.com \
...
%changelog
* Wed Aug 19 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 20.2.4-1
- Added Oracle specific files for 20.2.4
