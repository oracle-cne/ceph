...
%build
pushd container
NO_PUSH=true CI_CONTAINER=false VERSION="19.2.6" CEPH_VERSION="19.2.6" CONTAINER_REPO_HOSTNAME=container-registry.oracle.com \
...
%changelog
* Wed Aug 19 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 19.2.6-1
- Added Oracle specific files for 19.2.6
