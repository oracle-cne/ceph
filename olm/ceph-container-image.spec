...
%build
pushd container
NO_PUSH=true CI_CONTAINER=false VERSION="21.1.1" CEPH_VERSION="21.1.1" CONTAINER_REPO_HOSTNAME=container-registry.oracle.com \
...
%changelog
* Thu Sep 10 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 21.1.1-1
- Added Oracle specific files for 21.1.1
